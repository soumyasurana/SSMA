...
extension CustomerQueryFilter
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> pendingDuesEqualTo(
    double value, {
    double epsilon = Query.epsilon,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'pendingDues',
        value: value,
        epsilon: epsilon,
      ));
    });
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> pendingDuesLessThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> pendingDuesBetween(
    double lower,
    double upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension CustomerQuerySortBy on QueryBuilder<Customer, Customer, QSortBy> {
  ...
  QueryBuilder<Customer, Customer, QAfterSortBy> sortByPendingDues() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'pendingDues', Sort.asc);
    });
  }

  QueryBuilder<Customer, Customer, QAfterSortBy> sortByPendingDuesDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'pendingDues', Sort.desc);
    });
  }
...
extension CustomerQuerySortThenBy
  ...
  QueryBuilder<Customer, Customer, QAfterSortBy> thenByPendingDues() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'pendingDues', Sort.asc);
    });
  }

  QueryBuilder<Customer, Customer, QAfterSortBy> thenByPendingDuesDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'pendingDues', Sort.desc);
    });
  }
...
extension CustomerQueryWhereDistinct
  ...
  QueryBuilder<Customer, Customer, QDistinct> distinctByPendingDues() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'pendingDues');
    });
  }
...
extension CustomerQueryProperty
  ...
  QueryBuilder<Customer, bool, QQueryOperations> deletedProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Customer, double, QQueryOperations> pendingDuesProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'pendingDues');
    });
  }
