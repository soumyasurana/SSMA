...
class PDFService {
  static Future<void> generateInvoice(Sale sale) async {
    ...
    // ── helper styles ──────────────────────────────────────────────────────
    final headerStyle = pw.TextStyle(font: boldFont, fontSize: 12, color: PdfColors.white);
    final cellStyle   = pw.TextStyle(font: font,     fontSize: 11);
    final labelStyle  = pw.TextStyle(font: font,     fontSize: 12, color: PdfColors.grey700);
                ...
                children: [
                  pw.Column(
                    ...
                    children: [
                      ...
                      if (sale.buyerContact != null && sale.buyerContact!.isNotEmpty)
                ...
                children: [
                      ...
                      pw.Container(
                        ...
                        child: pw.Row(
                          ...
                          children: [
                            ...
                            pw.Text('Rs. ${e.value.toStringAsFixed(2)}', style: valueStyle),
                          ],
                        ),
                      ),
                    ],
                      ...
                      child: pw.Row(
                        ...
                        children: [
                          ...
                          pw.Text('Rs. ${previousBalance.toStringAsFixed(2)}',
                              style: pw.TextStyle(
                                  font: boldFont, fontSize: 12, color: PdfColors.red)),
                        ],
                      ),
                    ),
                  ],
                    ...
                    pw.Container(
                      ...
                      child: pw.Row(
                        ...
                        children: [
                          ...
                          pw.Text('Rs. ${sale.amountReceived.toStringAsFixed(2)}',
                              style: pw.TextStyle(
                                  font: boldFont, fontSize: 12, color: PdfColors.green800)),
                        ],
                      ),
                    ),
                  ],
                  ...
                  pw.Container(
                    ...
                    child: pw.Row(
                      ...
                      children: [
                        pw.Text(
                          sale.saleType == SaleType.credit ? 'Net Due:' : 'Grand Total:',
          ...
          if (cleanComment != null && cleanComment.isNotEmpty)
            pw.Container(
              ...
              child: pw.Row(
                crossAxisAlignment: pw.CrossAxisAlignment.start,
                children: [
                  pw.Text('Note: ', style: pw.TextStyle(font: boldFont, fontSize: 12)),
                  pw.Expanded(
                    child: pw.Text(
                      cleanComment,
                      style: pw.TextStyle(
                          font: font, fontSize: 12, fontStyle: pw.FontStyle.italic),
                    ),
                  ),
                ],
              ),
    ...
    pdf.addPage(
      pw.MultiPage(
        build: (context) => [
          ...
          ...sales.map(
              (s) => pw.Text('• ${s.buyerName ?? "Customer"} - ${s.totalAmount.toStringAsFixed(2)}')),
          pw.SizedBox(height: 12),
          ...
          ...payments.map(
              (p) => pw.Text('• ${p.amount.toStringAsFixed(2)} - ${p.note ?? "No note"}')),
        ],
      ),
    );
      ...
      pw.Page(
        ...
        build: (context) => pw.Column(
          ...
          children: [
            ...
            pw.SizedBox(height: 16),
            pw.Text(
                'Previous Due: ${payment.previousDue.toStringAsFixed(2)}',
                style: pw.TextStyle(font: font, fontSize: 12)),
            pw.Text(
